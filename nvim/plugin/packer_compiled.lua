...
vim.cmd [[au BufEnter * ++once lua require("packer.load")({'indent-blankline.nvim', 'vim-multiple-cursors', 'gitsigns.nvim', 'neoscroll.nvim', 'nvim-comment', 'LuaSnip'}, { event = "BufEnter *" }, _G.packer_plugins)]]
