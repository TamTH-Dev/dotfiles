...
vim.cmd [[au BufEnter * ++once lua require("packer.load")({'indent-blankline.nvim', 'nvim-snippy', 'gitsigns.nvim', 'neoscroll.nvim', 'nvim-comment', 'vim-multiple-cursors'}, { event = "BufEnter *" }, _G.packer_plugins)]]
