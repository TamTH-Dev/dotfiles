...
vim.cmd [[au BufEnter * ++once lua require("packer.load")({'indent-blankline.nvim', 'gitsigns.nvim', 'nvim-comment', 'neoscroll.nvim', 'LuaSnip', 'vim-multiple-cursors'}, { event = "BufEnter *" }, _G.packer_plugins)]]
