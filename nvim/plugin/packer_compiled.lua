...
vim.cmd [[au BufEnter * ++once lua require("packer.load")({'vim-multiple-cursors', 'gitsigns.nvim', 'nvim-snippy', 'neoscroll.nvim', 'indent-blankline.nvim'}, { event = "BufEnter *" }, _G.packer_plugins)]]
