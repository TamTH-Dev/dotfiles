...
vim.cmd [[au BufEnter * ++once lua require("packer.load")({'indent-blankline.nvim', 'gitsigns.nvim', 'neoscroll.nvim', 'vim-multiple-cursors', 'nvim-comment', 'LuaSnip'}, { event = "BufEnter *" }, _G.packer_plugins)]]
