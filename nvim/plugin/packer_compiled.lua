...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp-nvim-lsp", "nvim-autopairs", "cmp-nvim-lua", "cmp-buffer", "friendly-snippets", "cmp-path", "cmp-treesitter", "cmp-emoji", "cmp-calc" },
