...
vim.cmd [[au BufEnter * ++once lua require("packer.load")({'vim-multiple-cursors', 'nvim-snippy', 'neoscroll.nvim', 'gitsigns.nvim', 'indent-blankline.nvim'}, { event = "BufEnter *" }, _G.packer_plugins)]]
