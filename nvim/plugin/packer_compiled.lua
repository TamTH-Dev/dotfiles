...
_G.packer_plugins = {
  ...
  ["cmp-snippy"] = {
    after_files = { "/home/madlife/.local/share/nvim/site/pack/packer/opt/cmp-snippy/after/plugin/cmp_snippy.lua" },
    load_after = {
      ["nvim-cmp"] = true,
      ["nvim-snippy"] = true
    },
    loaded = false,
    needs_bufread = false,
    path = "/home/madlife/.local/share/nvim/site/pack/packer/opt/cmp-snippy"
  },
  ["cmp-treesitter"] = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp-nvim-lsp", "nvim-autopairs", "cmp-nvim-lua", "cmp-buffer", "friendly-snippets", "cmp-path", "cmp-treesitter", "cmp-emoji", "cmp-snippy", "cmp-calc" },
  ...
  ["nvim-snippy"] = {
    after = { "nvim-cmp", "friendly-snippets", "cmp-snippy" },
    loaded = false,
    needs_bufread = true,
    only_cond = false,
...
vim.cmd [[au BufEnter * ++once lua require("packer.load")({'indent-blankline.nvim', 'nvim-snippy', 'gitsigns.nvim', 'nvim-comment', 'neoscroll.nvim', 'vim-multiple-cursors'}, { event = "BufEnter *" }, _G.packer_plugins)]]
