...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp-nvim-lsp", "nvim-autopairs", "cmp-treesitter", "cmp-nvim-lua", "cmp-buffer", "cmp-path", "friendly-snippets", "cmp-emoji", "cmp-calc" },
...
try_loadstring("\27LJ\1\0023\0\0\2\0\3\0\0064\0\0\0%\1\1\0>\0\2\0027\0\2\0>\0\1\1G\0\1\0\tinit\vcolors\frequire\0", "config", "gruvbox.nvim")
