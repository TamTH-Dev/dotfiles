...
vim.cmd [[au BufEnter * ++once lua require("packer.load")({'nvim-cmp', 'emmet-vim', 'indent-blankline.nvim', 'vim-surround'}, { event = "BufEnter *" }, _G.packer_plugins)]]
