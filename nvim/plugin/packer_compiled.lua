...
vim.cmd [[au BufEnter * ++once lua require("packer.load")({'nvim-snippy', 'gitsigns.nvim', 'indent-blankline.nvim', 'vim-multiple-cursors', 'neoscroll.nvim'}, { event = "BufEnter *" }, _G.packer_plugins)]]
