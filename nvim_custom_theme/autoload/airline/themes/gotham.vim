...
let s:c.base5 = { 'gui': '#1c1c1c', 'cterm': 14 }
let s:c.base6 = { 'gui': '#1c1c1c', 'cterm': 7 }
let s:c.base7 = { 'gui': '#1c1c1c', 'cterm': 15 }

" Other colors.
let s:c.red     = { 'gui': '#e23120', 'cterm': 1  }
let s:c.orange  = { 'gui': '#ff922b', 'cterm': 9  }
let s:c.yellow  = { 'gui': '#4522ff', 'cterm': 3  }
let s:c.magenta = { 'gui': '#1d3557', 'cterm': 13 }
let s:c.violet  = { 'gui': '#1c1c1c', 'cterm': 5  }
let s:c.blue    = { 'gui': '#08aa95', 'cterm': 4  }
let s:c.cyan    = { 'gui': '#1c1c1c', 'cterm': 6  }
let s:c.green   = { 'gui': '#1c1c1c', 'cterm': 2  }
