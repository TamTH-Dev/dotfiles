...
_G.packer_plugins = {
  ...
  ["nvim-web-devicons"] = {
    after = { "galaxyline.nvim", "barbar.nvim", "nvim-tree.lua" },
...
vim.cmd [[au BufEnter * ++once lua require("packer.load")({'indent-blankline.nvim', 'gitsigns.nvim', 'vim-multiple-cursors', 'nvim-snippy', 'neoscroll.nvim'}, { event = "BufEnter *" }, _G.packer_plugins)]]
