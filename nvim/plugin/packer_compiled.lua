...
vim.cmd [[au BufEnter * ++once lua require("packer.load")({'gitsigns.nvim', 'neoscroll.nvim', 'indent-blankline.nvim', 'nvim-cmp'}, { event = "BufEnter *" }, _G.packer_plugins)]]
