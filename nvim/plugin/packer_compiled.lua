...
vim.cmd [[au BufEnter * ++once lua require("packer.load")({'neoscroll.nvim', 'nvim-snippy', 'gitsigns.nvim', 'vim-multiple-cursors', 'indent-blankline.nvim'}, { event = "BufEnter *" }, _G.packer_plugins)]]
vim.cmd [[au VimEnter * ++once lua require("packer.load")({'packer.nvim'}, { event = "VimEnter *" }, _G.packer_plugins)]]
vim.cmd [[au InsertEnter * ++once lua require("packer.load")({'emmet-vim', 'vim-surround', 'vim-closetag'}, { event = "InsertEnter *" }, _G.packer_plugins)]]
