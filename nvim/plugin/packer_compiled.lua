...
vim.cmd [[au BufEnter * ++once lua require("packer.load")({'indent-blankline.nvim', 'gitsigns.nvim', 'neoscroll.nvim', 'nvim-cmp'}, { event = "BufEnter *" }, _G.packer_plugins)]]
