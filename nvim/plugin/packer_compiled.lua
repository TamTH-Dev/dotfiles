...
vim.cmd [[au BufEnter * ++once lua require("packer.load")({'vim-surround', 'emmet-vim', 'indent-blankline.nvim', 'nvim-cmp'}, { event = "BufEnter *" }, _G.packer_plugins)]]
