...
_G.packer_plugins = {
  ...
  ["gruvbox.nvim"] = {
    ...
    loaded = true,
    path = "/home/madlife/.local/share/nvim/site/pack/packer/start/gruvbox.nvim",
  ...
  ["nvim-cmp"] = {
    after = { "cmp-nvim-lsp", "nvim-autopairs", "cmp-nvim-lua", "cmp-buffer", "cmp-path", "friendly-snippets", "cmp-treesitter", "cmp-calc", "cmp-emoji" },
